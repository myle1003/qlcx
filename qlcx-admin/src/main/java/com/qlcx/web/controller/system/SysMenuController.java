...
public class SysMenuController extends BaseController
{
    ...
    public AjaxResult remove(@PathVariable("menuId") Long menuId)
    {
        ...
        {
            return AjaxResult.warn("There is a submenu, delete is not allowed");
        }
        if (menuService.selectCountRoleMenuByMenuId(menuId)> 0)
        {
            return AjaxResult.warn("Menu has been assigned, delete is not allowed");
        }
    ...
    public AjaxResult addSave(@Validated SysMenu menu)
    {
        ...
        {
            return error("Add new menu'" + menu.getMenuName() + "'Failed, menu name already exists");
        }
    ...
    /**
     * Load the character menu list tree
     */
