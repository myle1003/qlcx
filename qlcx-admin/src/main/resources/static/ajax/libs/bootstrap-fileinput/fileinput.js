...
(function (factory) {
    ...
    $.fn.fileinputLocales.zh = {
        ...
        removeLabel: 'Tẩy',
        removeTitle: 'Xóa lựa chọn của Trung Quốc',
        cancelLabel: 'hủy bỏ',
        cancelTitle: 'Đang hủy tải lên',
        pauseLabel: 'Pause',
        pauseTitle: 'Pause ongoing upload',
        uploadLabel: 'Tải lên',
        uploadTitle: 'Tải lên và chọn lọc Trung Quốc',
        msgNo: 'Không',
        msgNoFilesSelected: 'Không có tập tin được chọn',
        msgPaused: 'Paused',
        msgCancelled: 'hủy bỏ',
        msgPlaceholder: 'lựa chọn{files}...',
        msgZoomModalHeading: 'Xem trước chi tiết ',
        msgFileRequired: 'Phải chọn một tệp để tải lên.',
        msgSizeTooSmall: 'tập tin "{name}" (<b>{size} KB</b>) Phải lớn hơn kích thước giới hạn <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'tập tin "{name}" (<b>{size} KB</b>) Vượt quá kích thước cho phép <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Bạn phải chọn ít nhất<b>{n}</b> {files} Tải lên. ',
        msgFilesTooMany: 'Số lượng tệp tải lên đã chọn<b>({n})</b> Vượt quá số lượng tệp tối đa <b>{m}</b>.',
        msgFileNotFound: 'tập tin "{name}" Không tìm thấy!',
        msgFileSecured: 'Các hạn chế bảo mật để ngăn việc đọc tệp"{name}".',
        msgFileNotReadable: 'tập tin "{name}" Không đọc được.',
        msgFilePreviewAborted: 'hủy bỏ "{name}" Bản xem trước của.',
        msgFilePreviewError: 'Đọc "{name}" Đã xảy ra lỗi.',
        msgInvalidFileName: 'tên tập tin "{name}" Chứa các ký tự bất hợp pháp.',
        msgInvalidFileType: 'Loại không chính xác "{name}". Chỉ hỗ trợ"{types}" Loại file.',
        msgInvalidFileExtension: 'Phần mở rộng tệp không chính xác "{name}". Chỉ hỗ trợ "{extensions}" Phần mở rộng tệp.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadAborted: 'Quá trình tải lên tệp đã bị hủy bỏ',
        msgUploadThreshold: 'Chế biến...',
        msgUploadBegin: 'khởi tạo...',
        msgUploadEnd: 'thực hiện',
        msgUploadResume: 'Resuming upload...',
        msgUploadEmpty: 'Tải lên tệp không hợp lệ.',
        msgUploadError: 'Upload Error',
        msgDeleteError: 'Delete Error',
        msgProgressError: 'Lỗi tải lên',
        msgValidationError: 'Lỗi xác nhận',
        msgLoading: 'Đang tải phần {index} Tổng số tệp {files} &hellip;',
        msgProgress: 'Đang tải phần {index} Tổng số tệp {files} - {name} - {percent}% thực hiện.',
        msgSelected: '{n} {files} 选中',
        msgFoldersNotAllowed: 'Chỉ hỗ trợ kéo và thả tệp! nhảy qua {n} Kéo và thả thư mục.',
        msgImageWidthSmall: 'Chiều rộng của "{name}" của tệp hình ảnh ít nhất phải bằng{size}Pixel.',
        msgImageHeightSmall: 'Chiều cao của "{name}" của tệp hình ảnh ít nhất phải là {size} pixel.',
        msgImageWidthLarge: 'Chiều rộng của tệp hình ảnh "{name}" không được vượt quá {size} pixel.',
        msgImageHeightLarge: 'Chiều cao của tệp hình ảnh "{name}" không được vượt quá {size} pixel.',
        msgImageResizeError: 'Không thể điều chỉnh kích thước hình ảnh.',
        msgImageResizeException: 'Đã xảy ra lỗi khi thay đổi kích thước hình ảnh. <pre> {errors} </pre>',
        msgAjaxError: '{operation} Có một lỗi đã xảy ra. Xin hãy thử lại!',
        msgAjaxProgressError: '{operation} sự thất bại',
        msgDuplicateFile: 'File "{name}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.',
        msgResumableUploadRetriesExceeded:  'Upload aborted beyond <b>{max}</b> retries for file <b>{file}</b>! Error Details: <pre>{error}</pre>',
        msgPendingTime: '{time} remaining',
        msgCalculatingTime: 'calculating time remaining',
        ajaxOperations: {
            deleteThumb: 'Xóa các tập tin',
            uploadThumb: 'tải tệp lên',
            uploadBatch: 'Tải lên hàng loạt',
            uploadExtra: 'Tải lên dữ liệu biểu mẫu'
        },
        dropZoneTitle: 'Kéo và thả tệp vào đây &hellip;<br>Hỗ trợ tải lên đồng thời nhiều tệp',
        dropZoneClickTitle: '<br>(Hoặc bấm vào{files}Nút để chọn tệp)',
        fileActionSettings: {
            removeTitle: 'Xóa các tập tin',
            uploadTitle: 'tải tệp lên',
            downloadTitle: 'Tải tập tin',
            uploadRetryTitle: 'Thử lại',
            zoomTitle: 'xem chi tiết',
            dragTitle: 'di động / Cài lại',
            indicatorNewTitle: 'Không được tải lên',
            indicatorSuccessTitle: 'Tải lên',
            indicatorErrorTitle: 'Lỗi tải lên',
            indicatorPausedTitle: 'Upload Paused',
            indicatorLoadingTitle:  'Tải lên ...'
        },
        previewZoomButtonTitles: {
            prev: 'Xem trước tệp trước',
            next: 'Xem trước tệp tiếp theo',
            toggleheader: 'Thu phóng',
            fullscreen: 'toàn màn hình',
            borderless: 'Chế độ không viền',
            close: 'Đóng hiện tại xem trước'
        }
    };
