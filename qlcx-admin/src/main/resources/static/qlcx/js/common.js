...
var refreshItem = function(){
	...
	var target = $('.apm_iframe[data-id="' + currentId + '"]', topWindow);
...
var closeItem = function(dataId){
	...
	if($.common.isNotEmpty(dataId)){
		...
		$('.mainContent .apm_iframe[data-id="' + dataId + '"]', topWindow).remove();
		return;
	}
	...
	if($.common.isNotEmpty(panelUrl)){
		...
		$('.mainContent .apm_iframe', topWindow).each(function() {
            if ($(this).data('id') == panelUrl) {
                $(this).show().siblings('.apm_iframe').hide();
                return false;
            }
		});
	}
...
function createMenuItem(dataUrl, menuName) {
    ...
    if (flag) {
        ...
        var str1 = '<iframe class="apm_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" data-panel="' + panelUrl + '" seamless></iframe>';
        $('.mainContent', topWindow).find('iframe.apm_iframe').hide().parents('.mainContent').append(str1);
