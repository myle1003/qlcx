package com.qlcx.common.utils.security;
...
import com.qlcx.common.constant.PermissionConstants;
...
public class PermissionUtils
{
    ...
    /**
     * Quyền đối với dữ liệu khác
     */
    public static final String PERMISSION = "no.permission";

    /**
     * Lời nhắc thông báo lỗi quyền
     *
     * @param Thông báo lỗi  permissionsStr
     * @return Thông tin 
     */
    ...
    /**
     * Trả lại giá trị thuộc tính người dùng
     *
     * @param Tên thuộc tính tài sản 
     * @return giá trị thuộc tính người dùng
     */
