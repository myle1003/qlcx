...
import com.qlcx.common.annotation.DataSource;
...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.qlcx.common.annotation.DataSource)"
            + "|| @within(com.qlcx.common.annotation.DataSource)")
    ...
    /**
     * Get the data source to be switched
     */
