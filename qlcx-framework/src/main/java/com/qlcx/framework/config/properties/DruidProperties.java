package com.qlcx.framework.config.properties;
...
public class DruidProperties
{
    ...
    public DruidDataSource dataSource(DruidDataSource datasource)
    {
        ...
        /** Configure the time to wait for timeout to get a connection */
        datasource.setMaxWait(maxWait);

        /** Configure how often to perform a test at intervals to detect idle connections that need to be closed, in milliseconds */
        ...
        /**
         * The sql used to check whether the connection is valid, the requirement is a query statement, commonly used to select'x'. If the validationQuery is null, testOnBorrow, testOnReturn, testWhileIdle will not work.
         */
