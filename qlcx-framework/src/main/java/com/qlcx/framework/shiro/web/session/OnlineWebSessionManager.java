package com.qlcx.framework.shiro.web.session;
...
import com.qlcx.common.utils.bean.BeanUtils;
...
/**
 * Mainly, if the attributes of the session are modified, it will be modified, and then it will be convenient for OnlineSessionDao synchronization
 */
public class OnlineWebSessionManager extends DefaultWebSessionManager
{
    ...
    private boolean needMarkAttributeChanged(Object attributeKey)
    {
        ...
        // Optimization of flash attributes is not necessary for persistence
