package com.qlcx.quartz.controller;
...
public class SysJobController extends BaseController
{
    ...
    @Log(title = "Nhiệm vụ theo thời gian", businessType = BusinessType.EXPORT)
    ...
    public AjaxResult export(SysJob job)
    {
        ...
        return util.exportExcel(list, "Nhiệm vụ theo thời gian");
    }

    @Log(title = "Nhiệm vụ theo thời gian", businessType = BusinessType.DELETE)
     ...
     * 任务调度状态修改
     */
    @Log(title = "Nhiệm vụ theo thời gian", businessType = BusinessType.UPDATE)
     ...
     * Thêm vào调度
     */
    @Log(title = "Nhiệm vụ theo thời gian", businessType = BusinessType.INSERT)
