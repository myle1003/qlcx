...
import com.qlcx.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
     ...
     *
     * @param deptList 部门Danh sách
     * @param roleDeptList 角色已存在菜单Danh sách
     * @return 树结构Danh sách
     */
    ...
    public int insertDept(SysDept dept)
    {
        ...
        // 如果父节点不为"正常"状态,则不允许Thêm vào子节点
        if (!UserConstants.DEPT_NORMAL.equals(info.getStatus()))
        {
            throw new BusinessException("部门停用，不允许Thêm vào");
        }
